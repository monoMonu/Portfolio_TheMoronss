...
function Navbar() {
  return (
    <div className="bg-gradient-to-r from-[#565655ed] to-[#191918ed] text-white flex justify-between items-center px-10 py-2.5 h-10 mx-5 rounded-full sticky top-6">
      <h2 className="text-[20px] font-extrabold">Portfolio</h2>
      <nav className="flex items-center space-x-4 text-4">
        <a to={'/'} className="flex items-center text-white cursor-pointer">
